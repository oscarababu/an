...
function update() { 
  ...
  $(".thumb-nail").click(function(){
       // $('#thumb-nail-wrapper').fadeOut(75);
        $('#gallery-item-wrapper').fadeIn(200);
  });

  $(".cls_slide").click(function(){
    $('#gallery-item-wrapper').fadeOut(200);
    //$('#thumb-nail-wrapper').fadeIn(75);
  });

  */

function mouseOver(){
    alert("asdhhhhhhhhsdsad");
}