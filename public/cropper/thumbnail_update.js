$(function () {
  ...
  $("#save_gallery_image").click(function(){
    ...
    axios({
      ...
      var thumb_id = $("#hdn_thumb_id").val();
      
      axios({
        url:LOCAL_URL+'save_gallery_item_thumbnail',
        method:'POST',
        data: {"thumb_id":thumb_id,"type":"thumbnail","up_image":up_image,"item_id":itemId,"up_image_format":up_image_format,"up_image_public_id":up_image_public_id}
      }).then(function(res){
        //console.log(res);
        $(".msg").html(
